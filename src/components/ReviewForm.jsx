...
const ReviewForm = ({data, uptadeFieldHandler}) => {
  return (
    <div className = "review-form">
        ...
        <div className="form-control">
          <label htmlFor="comment">Cometário:</label>
          <textarea name="comment" id="comment" placeholder='Conte como foi a sua experiência com os produtos...' required value={data.comment || ""} onChange={(e)=> uptadeFieldHandler("comment", e.target.value)}></textarea>
        </div>
    </div>
  )
}
